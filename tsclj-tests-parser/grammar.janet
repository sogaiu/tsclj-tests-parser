...
(comment
  ...
  (peg/match clojure "2.0")
  # => @[]

  (peg/match clojure "6.022e23")
  # => @[]

  (peg/match clojure "1e8")
  # => @[]

  (peg/match clojure "1/2")
  # => @[]

  (peg/match clojure "0x1")
  # => @[]

  (peg/match clojure "01")
  # => @[]

  (peg/match clojure "017")
  # => @[]

  (peg/match clojure "0377")
  # => @[]

  (peg/match clojure "2r01")
  # => @[]

  (peg/match clojure "36rA")
  # => @[]
  ...
  (peg/match clojure "##Inf")
  # => @[]

  (peg/match clojure "## NaN")
  # => @[]
  ...
  (peg/match clojure "(defn hi [] 1)")
  # => @[]

  (peg/match clojure "^{:a true} [:a :b]")
  # => @[]

  (peg/match clojure "#?(:clj 1 :cljr 2)")
  # => @[]

  (peg/match clojure "#? (:clj 1 :cljr 2)")
  # => @[]

  (peg/match clojure "[#?@(:clj [:a] :cljr [:b])]")
  # => @[]
